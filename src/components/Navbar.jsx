...
export default function Navbar() {
  ...
  return (
    <>
          ...
          <div className="flex justify-between items-center h-20 sm:h-24 lg:h-28">
            ...
            >
              <div className="relative">
                <img
                  className="h-16 sm:h-20 lg:h-28 w-auto transition-all duration-300 group-hover:brightness-110"
                  src="/logoof.svg"
            ...
            <div className="flex items-center space-x-3 lg:space-x-4">
              <motion.button
                ...
                className="hidden md:flex items-center gap-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white px-4 lg:px-6 py-2 lg:py-2.5 rounded-full font-semibold hover:shadow-lg hover:shadow-blue-500/30 transition-all duration-300 group text-sm lg:text-base"
              >
                Get Started
      ...
      {/* Back to Top Button - Only show on desktop for better mobile performance */}
      <AnimatePresence>
        {scrolled && !isMobile && (
          <motion.button
