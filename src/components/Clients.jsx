  ...
  return (
    <section className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex flex-col gap-16 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
          {/* Top Row - 5 logos */}
            ...
            {clientLogos.slice(0, 5).map((client, i) => (
              <div key={client.name} className="flex justify-center items-center p-4 relative z-10">
                <img
                  ...
                  className="h-20 w-auto max-w-48 object-contain transition-all duration-300 hover:scale-105 drop-shadow-sm relative z-10"
                />
              </div>
            ))}
          </div>
